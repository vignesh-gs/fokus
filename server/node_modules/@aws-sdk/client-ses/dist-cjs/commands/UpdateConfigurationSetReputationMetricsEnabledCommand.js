...
class UpdateConfigurationSetReputationMetricsEnabledCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, UpdateConfigurationSetReputationMetricsEnabledCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_query_1.se_UpdateConfigurationSetReputationMetricsEnabledCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_query_1.de_UpdateConfigurationSetReputationMetricsEnabledCommand)(output, context);
    }
}
